                ...
                <div class="row y-middle mb-64 lg-mb-30 md-mb-0">
                    <div class="col-lg-6 md-mb-95">
                        <div class="image-part">
                            <img src="{{ asset('app/public/assets/images/about/inner/left-img.jpg') }}" alt="">
                        </div>
                    </div>
                ...
                <div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30" data-autoplay="true"
                    ...
                    <div class="team-item">
                        <div class="team-image">
                            <img src="{{ asset('app/public/assets/images/team/1.jpg') }}" alt="Team Image">
                        </div>
                    ...
                    <div class="team-item">
                        <div class="team-image">
                            <img src="{{ asset('app/public/assets/images/team/2.jpg') }}" alt="Team Image">
                        </div>
                        <div class="text-bottom">
                    ...
                    <div class="team-item">
                        <div class="team-image">
                            <img src="{{ asset('app/public/assets/images/team/3.jpg') }}" alt="Team Image">
                        </div>
                        <div class="text-bottom">
                    ...
                    <div class="team-item">
                        <div class="team-image">
                            <img src="{{ asset('app/public/assets/images/team/4.jpg') }}" alt="Team Image">
                        </div>
                        <div class="text-bottom">
                    ...
                    <div class="team-item">
                        <div class="team-image">
                            <img src="{{ asset('app/public/assets/images/team/5.jpg') }}" alt="Team Image">
                        </div>
                        <div class="text-bottom">
                    ...
                    <div class="team-item">
                        <div class="team-image">
                            <img src="{{ asset('app/public/assets/images/team/6.jpg') }}" alt="Team Image">
                        </div>
                        <div class="text-bottom">
